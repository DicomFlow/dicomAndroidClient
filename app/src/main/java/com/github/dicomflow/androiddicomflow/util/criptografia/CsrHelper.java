...
public class CsrHelper {
  ...
  private final static String CN_PATTERN = "CN=%s, O=Aralink, OU=OrgUnit";
    ...
    private static void gerando() throws NoSuchAlgorithmException, IOException, OperatorCreationException {
        //Generate KeyPair
...
//Generate CSR in PKCS#10 format encoded in DER
        PKCS10CertificationRequest csr = CsrHelper.generateCSR(keyPair, "meu_certificado");
