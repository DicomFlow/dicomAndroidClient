        ...
        private List<String> getDataFromApi2() throws IOException {
            ...
            ListMessagesResponse listResponse =
                    mService.users().messages()
                            .list(user)
//                            .setQ("subject:\"from app\" is:unread")
//                            .setFields("id")
                            .execute();
            ...
            JsonBatchCallback<Message> callback = new JsonBatchCallback<Message>() {
                ...
                public void onSuccess(Message message, HttpHeaders responseHeaders) {
                    Object o = message.getSnippet();
                    Log.d("xxx", "x " + (String) o);
                }
            ...
            for (Message m : listResponse.getMessages()) {
                mService.users().messages().get(user, m.getId())
                        .setFormat("METADATA")
//                        .setFields("title")
                        .queue(batch, callback);
//                        .execute();
//                labels.add((String) completedMessage.get("title"));
            }
            batch.execute();
            return labels;
        }
...
//            }
        ...
        public List<String> listMessagesMatchingQuery() throws IOException, JSONException {
            ...
            ListMessagesResponse response = mService.users().messages().list(userId)
                    .setQ("subject: \"[from app]\" is:unread").setLabelIds(lid).execute();
