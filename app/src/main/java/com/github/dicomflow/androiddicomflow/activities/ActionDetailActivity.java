 ...
 * in a {@link ServiceDetailActivity}.
 */
public class ActionDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(ActionDetailFragment.ARG_ACTION_ID,
                    getIntent().getStringExtra(ActionDetailFragment.ARG_ACTION_ID));
            arguments.putString(ServicoDetailFragment.ARG_SERVICE_ID,
                    getIntent().getStringExtra(ServicoDetailFragment.ARG_SERVICE_ID));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, ServiceDetailActivity.class));
            return true;
        }
