...
public class GenericFragment extends Fragment{
    ...
    private MakeRequestTask.IMakeRequestTask iMakeRequestTask;
     ...
     * appropriate.
     */
    protected void getResultsFromApi(MakeRequestTask.IMakeRequestTask iMakeRequestTask) {
        if (! isGooglePlayServicesAvailable()) {
            ...
            new MakeRequestTask(getContext(), iMakeRequestTask, mCredential, mProgressDialog).execute();
        }
    }
    ...
    private void chooseAccount() {
        if (EasyPermissions.hasPermissions(
            ...
            if (accountName != null) {
                ...
                getResultsFromApi(iMakeRequestTask);
            } else {
    ...
    //region Utils Device online, Google Play Services
    /**
